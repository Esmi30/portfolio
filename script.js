...
const tickerItems = [
  ...
  { name: 'Telegram',      icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/telegram/telegram-original.svg' },
  ...
  { name: 'Notion',        icon: 'https://www.notion.so/favicon.ico' },
